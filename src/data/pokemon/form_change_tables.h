...
static const struct FormChange sCastformFormChangeTable[] = {
    ...
    {FORM_CHANGE_OVERWORLD_WEATHER, SPECIES_CASTFORM_SUNNY,  WEATHER_SANDSTORM},
    ...
    {FORM_CHANGE_BATTLE_WEATHER,    SPECIES_CASTFORM_SUNNY, B_WEATHER_SANDSTORM, ABILITY_FORECAST},
