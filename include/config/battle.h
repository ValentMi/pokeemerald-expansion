...
#define B_SHEER_COLD_IMMUNITY       FALSE // In Gen7+, Ice-types are immune to Sheer Cold
...
// Other battle flags
#define B_FLAG_INVERSE_BATTLE       0x881     // If this flag is set, the battle's type effectiveness are inversed. For example, fire is super effective against water.
...
#define B_FLAG_DYNAMAX_BATTLE       0x882     // If this flag is set, the ability to Dynamax in battle is enabled for all trainers.
#define B_FLAG_TERA_ORB_CHARGED     0x883     // If this flag is set, the Tera Orb is charged. It is automatically set upon healing and cleared upon Terastallizing once configured.
#define B_FLAG_TERA_ORB_NO_COST     0x884     // If this flag is set, the Tera Orb does not use up its charge upon Terastallization. In S/V, this occurs after an event with Terapagos.
